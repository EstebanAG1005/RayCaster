...
def glize(node):
    ...
    for mesh in node.meshes:
        ...
        glUniform3f(glGetUniformLocation(shader, "light"), -100, 300, 0)

        glUniform4f(glGetUniformLocation(shader, "diffuse"), 0, 0, 0.8, 1)

        glUniform4f(glGetUniformLocation(shader, "ambient"), 0.2, 0.2, 0.2, 1)

        glUniform4f(glGetUniformLocation(shader, "carnage"), 0.8, 0, 0, 1)
